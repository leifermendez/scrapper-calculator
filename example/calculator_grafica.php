...
use leifermendez\scrapper_calculator\Grafica;
...
$grafica = new Grafica($base_datos);
$grafica->calculatorGrafica('global', '40.4238647', '-3.700173', 1, array('bano'=>7), 1500, 500);
