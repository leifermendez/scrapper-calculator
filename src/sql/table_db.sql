CREATE TABLE IF NOT EXISTS `apartaments` (
  ...
  `anunciante` text COLLATE utf8_spanish_ci NOT NULL,
  ...
  `certificacionEnergetica` text COLLATE utf8_spanish_ci NOT NULL,
  ...
  `calefaccionIndividual` text COLLATE utf8_spanish_ci NOT NULL,
